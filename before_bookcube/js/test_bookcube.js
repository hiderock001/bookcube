...
function book_down(sku){
	window.open(httpUrl + '/download/test_book_down.asp?sku='+sku,'download','width=490,height=670,scrollbars=yes,toolbar=no');
}

function serial_down(serialcheck){
	window.open(httpUrl + '/download/test_book_down_serial.asp?serialCheck='+serialcheck,'download','width=300,height=200,scrollbars=no,toolbar=no');
}

function serial_down_order(order_num, serial_num){
	window.open(httpUrl + '/download/test_book_down_serial.asp?order_num='+order_num+'&serial_num='+serial_num,'download','width=300,height=200,scrollbars=no,toolbar=no');
}
...
function multidownloader(){
	...
	window.open(httpUrl + '/download/test_book_down.asp','download','width=490,height=670,scrollbars=yes,toolbar=no');
}
...
function visit_history_input(){
	...
	$.ajax({
		url : '/storycube/common/_visit_history_input.asp',
		data : {},
		type : 'post',
		dataType : 'json',
		headers : {'cache-control' : "no-cache"},
